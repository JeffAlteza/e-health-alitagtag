...
{
    public function execute(PatientRecordData $patientRecordData): PatientRecord
    {
        $patientRecord = PatientRecord::create($this->getPatientRecordAttributes($patientRecordData));
